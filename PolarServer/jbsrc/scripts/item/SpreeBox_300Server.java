...
//佳人礼包+100钻石 →战魂*1000，海心铁精*2，攻击属性百宝箱*20，江山礼包*1
//山河礼包+500钻石 →战魂*5000，骑兵祝福丹*1，装备进阶石*10，王城礼包*1
//王城礼包+2000钻石→10倍收益丹*2 战魂*2w，帝王礼包*1
//帝王礼包+10000钻石→战盟令牌*20  锻骨草*1
...
public class SpreeBox_300Server implements IItemScript {
	...
	//美人礼包+100钻石 →战魂*1000，海心铁精*2，攻击属性百宝箱*20，江山礼包*1
	public void open1(List<Object> para){
		...
		if(!ManagerPool.backpackManager.checkGold(player, gold)){
			MessageUtil.notify_player(player, Notifys.MOUSEPOS, "您的钻石不足{1}", gold+"");
			return;
		}
	...
	//江山礼包+500钻石 →战魂*5000，骑兵祝福丹*1，装备进阶石*10，王城礼包*1
