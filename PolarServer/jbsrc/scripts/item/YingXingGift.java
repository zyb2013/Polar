...
public class YingXingGift implements IItemScript {
	...
	public YingXingGift(){
		//钻石
		panelmap.put("9169_yb", "200");
		panelmap.put("9170_yb", "500");
		panelmap.put("9171_yb", "1000");
		//面板ID
		panelmap.put("9169_panel", "16");
		panelmap.put("9170_panel", "17");
		panelmap.put("9171_panel", "18");
		//给道具
		panelmap.put("9169_items", "1024,3,0,1;-3,20000;1011,5,0,1;9170,1,0,1");
		panelmap.put("9170_items", "1024,3,0,1;-6,2000;1011,10,0,1;9171,1,0,1");
		panelmap.put("9171_items", "1019,1,0,1;-6,5000;1011,20,0,1");
		//给装备阶数
		panelmap.put("9170_equip", "5,7");
		panelmap.put("9171_equip", "10,10");
	}
...
//			if (item.getQ_sex() != 0 && item.getQ_sex() != player.getSex()) continue;没有性别要求了 luminghua hide
