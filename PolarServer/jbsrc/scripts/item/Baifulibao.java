...
//			免费开启可获得：大真气丹*1、50绑钻、50军功、200战魂
//			花100钻石开启：大真气丹*5、100绑钻、200军功、500战魂
//			花200钻石开启：大真气丹*15、300绑钻、500军功、1500战魂
//			花500钻石开启：大真气丹*50、800绑钻、1500军功、5000战魂
			String itemString = "";
			...
			if (!BackpackManager.getInstance().checkGold(player, costgold)) {
				MessageUtil.notify_player(player, Notifys.ERROR, ResManager.getInstance().getString("您的钻石不足{1}，不能兑换百服礼包。"), "" + costgold);
				return;
			}
			//检测2级密码
