...
//		IQuitMapScript script = (IQuitMapScript) ManagerPool.scriptManager.getScript(pt_scriptid);
//		if (script != null) {
//			try {
...
//		2014.1.4 hongxiao.z
//		script = (IQuitMapScript) ManagerPool.scriptManager.getScript(jiaochang_scriptid);
//		if (script != null) {
//			try {
//				script.onQuitMap(player, map);
//			} catch (Exception e) {
...
//		}
//		
//		script = (IQuitMapScript) ManagerPool.scriptManager.getScript(ScriptEnum.BF4V4);
//		if (script != null) {
//			try {
//				script.onQuitMap(player, map);
//			} catch (Exception e) {
