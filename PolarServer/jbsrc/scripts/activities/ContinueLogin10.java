...
public class ContinueLogin10 implements IActivityScript{

	private static String KEY = "CONTINUELOGIN10";
	...
	public String getDescribe(Player player) {
		return "连续10天登录游戏可领取二测绑钻奖励：20000,（若中断，登录天数将重置为1）";
	}

	@Override //红玫瑰（绑）*3、双倍收益丹（绑）*1、绑钻*100、回城卷（绑）*10、真气丹(绑）*3
