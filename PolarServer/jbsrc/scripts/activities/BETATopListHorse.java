...
public class BETATopListHorse implements IActivityScript {

	@Override
	public int getId() {
		return ScriptEnum.BETA_TOPLISTHORSE;
	}
	...
	public String getRewardInfo(Player player) {
		return "[[{\"id\":8417, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 10000 + "}]"
			  +",[{\"id\":8418, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 5000 + "}]"
			  +",[{\"id\":8419, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 2000 + "}]]";
	}
