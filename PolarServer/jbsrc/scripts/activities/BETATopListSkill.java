...
public class BETATopListSkill implements IActivityScript {

	@Override
	public int getId() {
		return ScriptEnum.BETA_TOPLISTSKILL;
	}
	...
	public String getRewardInfo(Player player) {
		return "[[{\"id\":8414, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 10000 + "}]"
			  +",[{\"id\":8415, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 5000 + "}]"
			  +",[{\"id\":8416, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 2000 + "}]]";
	}
