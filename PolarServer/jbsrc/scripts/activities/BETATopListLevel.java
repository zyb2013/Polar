...
public class BETATopListLevel implements IActivityScript {

	@Override
	public int getId() {
		return ScriptEnum.BETA_TOPLISTLEVEL;
	}
	...
	public String getRewardInfo(Player player) {
		return "[[{\"id\":8411, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 10000 + "}]"
			  +",[{\"id\":8412, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 5000 + "}]"
			  +",[{\"id\":8413, \"num\":" + 1 + "},{\"id\":-5, \"num\":" + 2000 + "}]]";
	}
