...
public class AttackResultInfo extends Bean {
	...
	//当前血量
	private int entityIdhp;
	
	//特殊攻击，0-失败  
	private int fightSpecialRes;
	...
	public boolean write(IoBuffer buf){
		...
		writeInt(buf, this.entityIdhp);
		//! 特效攻击
		writeInt(buf, this.fightSpecialRes);
		return true;
	}
	...
	public boolean read(IoBuffer buf){
		...
		this.entityIdhp = readInt(buf);
		//! 特效攻击
		this.fightSpecialRes = readInt(buf);
		return true;
	}
	 ...
	 * set 反伤
	 */
	public void setentityIdhp(int entityIdhp){
		this.entityIdhp = entityIdhp;
	}
	 ...
	 * @return
	 */
	public int getFightSpecialRes(){
		return fightSpecialRes;
	}
	
	/**
	 * set 特效攻击
	 */
	public void setFightSpecialRes(int fightSpecialRes){
		this.fightSpecialRes = fightSpecialRes;
	}
	...
	public String toString(){
		...
		buf.append("entityIdhp:" + entityIdhp +",");
		//! 特效攻击
		buf.append("fightSpecialRes:" + fightSpecialRes + ",");
