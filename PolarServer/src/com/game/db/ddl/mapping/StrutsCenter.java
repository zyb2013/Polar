...
import com.game.db.ddl.struts.BankLogStruts;
import com.game.db.ddl.struts.BlackListStruts;
import com.game.db.ddl.struts.CastingExchangeDataStruts;
import com.game.db.ddl.struts.CastingRewardDataStruts;
import com.game.db.ddl.struts.CastingUseItemDataStruts;
import com.game.db.ddl.struts.DBStruts;
import com.game.db.ddl.struts.FractionDataStruts;
import com.game.db.ddl.struts.GameMasterStruts;
import com.game.db.ddl.struts.GoldExpendStruts;
import com.game.db.ddl.struts.GoldRaffleDataStruts;
import com.game.db.ddl.struts.GoldRechargeLogStruts;
import com.game.db.ddl.struts.GoldStruts;
import com.game.db.ddl.struts.LivenessDataStruts;
import com.game.db.ddl.struts.MarriedStruts;
import com.game.db.ddl.struts.PrayDataStruts;
import com.game.db.ddl.struts.ProtectStruts;
...
public class StrutsCenter {
	...
	public List<DBStruts> getTableList(){
		...
		list.add(new ProtectStruts());
		list.add(new GoldExpendStruts());
		//add hongxiao.z
		list.add(new LivenessDataStruts());
		list.add(new PrayDataStruts());
		list.add(new GoldRaffleDataStruts());
		list.add(new FractionDataStruts());
		
		list.add(new BankLogStruts());
		list.add(new CastingRewardDataStruts());
		list.add(new CastingUseItemDataStruts());
		list.add(new CastingExchangeDataStruts());
		return list;
	}
}
