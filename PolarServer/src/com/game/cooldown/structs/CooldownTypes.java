...
public enum CooldownTypes {
	...
	//宠物跑动冷确
		SUMMONPET_RUN			("MONSTER_RUN"),
		//宠物攻击冷却
		SUMMONPET_ATTACK		("SUMMONPET_ATTACK"),
		//宠物动作冷确
		SUMMONPET_ACTION		("SUMMONPET_ACTION"),
	...
	//包裹整理冷确
	GOLD_RAFFLE_CLEAR	("GOLD_RAFFLE_CLEAR")
	;
