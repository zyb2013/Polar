					...
					if (powers != null) {
						for (Map.Entry<String, Integer> entry : powers.entrySet()) {
							...
							if (attString.equalsIgnoreCase(CommonString.ATTACK)) {
								...
								patt.setPhysic_attacklower(attInteger);
								patt.setPhysic_attackupper(attInteger);
								patt.setMagic_attacklower(attInteger);
								patt.setMagic_attackupper(attInteger);
							} else if (attString.equalsIgnoreCase(CommonString.ATTACKPERCENT)) {
								patt.setAttackPercent(attInteger);
								patt.setPhysic_attackPercent(attInteger);
								patt.setMagic_attackPercent(attInteger);
