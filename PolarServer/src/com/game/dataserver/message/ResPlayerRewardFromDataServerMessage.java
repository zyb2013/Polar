...
import com.game.dataserver.bean.RewardInfo;
 ...
 * @version 1.0.0
 * 
 * 返回请求公共服务器玩家奖励信息（公共数据服务器到游戏服务器）消息
 */
public class ResPlayerRewardFromDataServerMessage extends Message{
	...
	//奖励数据
	private List<RewardInfo> reward = new ArrayList<RewardInfo>();
	...
	public boolean read(IoBuffer buf){
		...
		for (int i = 0; i < reward_length; i++) {
			reward.add((RewardInfo)readBean(buf, RewardInfo.class));
		}
		//返回是否需要现在跨服 0-不需要 1-需要
