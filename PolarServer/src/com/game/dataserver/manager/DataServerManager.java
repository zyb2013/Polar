...
public class DataServerManager {
	...
	public void resSyncPlayerToDataServer(ResSyncPlayerToDataServerMessage msg){
		...
		if(msg.getResult()==UserState.WAIT_CROSS){
			...
			returnmsg.setServerId(msg.getServerId());
			returnmsg.setWeb(WServer.getInstance().getServerWeb());
			returnmsg.setServerIp(msg.getServerIp());
			returnmsg.setServerPort(msg.getServerPort());
			returnmsg.setServerSSLPort(msg.getServerSSLPort());
