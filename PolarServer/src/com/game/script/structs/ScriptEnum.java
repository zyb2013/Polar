...
public class ScriptEnum {
	...
	/**
	 * 活动脚本	add hongxiao.z 2014.2.10
	 */
	public static int ACTIVITY_GRADE_GIFT = 55003; //开服第一天活动脚本,等级礼包
//	public static int ACTIVITY_OPEN_2 = 1002;	  //开服第二天活动脚本
//	public static int ACTIVITY_OPEN_3 = 1003;	  //开服第三天活动脚本
//	public static int ACTIVITY_OPEN_4 = 1004;	  //开服第四天活动脚本
//	public static int ACTIVITY_OPEN_5 = 1005;	  //开服第五天活动脚本
//	public static int ACTIVITY_OPEN_6 = 1006;	  //开服第六天活动脚本
//	public static int ACTIVITY_OPEN_7 = 1007;	  //开服第七天活动脚本
	
	
	/* ------------------ 废弃 -----------------*/
	/**
	 * 公测活动脚本  BETA
	 * 废弃 hongxiao.z 2014.2.10
	 */
	...
	public static int BETA_LORDGUILD=2089;         //公测圣盟领奖
	public static int BETA_SHOPDISCOUNT=2093;      //商城打折
	public static int BETA_SEALREWARD=2095;        //封测绑钻
	...
	public static int GUILDFLAG = 9001;//战盟领地战
	public static int BIWUDAO = 9002;//比武岛
	public static int BF4V4 = 4013;//跨服4v4
	
	public static int CSYS = 55012;//跨服4v4
	/* ------------------ end -----------------*/
}
