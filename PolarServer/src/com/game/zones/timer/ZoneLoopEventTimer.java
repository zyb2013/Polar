...
public class ZoneLoopEventTimer extends TimerEvent {
	
	private Logger log = Logger.getLogger(ZoneLoopEventTimer.class);
	//脚本Id
	...
	public ZoneLoopEventTimer(int scriptId, long zoneId, int zoneModelId, List<Object> parameters, long delay) {
		super(-1, delay);
