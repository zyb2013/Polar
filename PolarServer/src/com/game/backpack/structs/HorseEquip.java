...
public class HorseEquip extends Equip {
	...
	public void use(Player player, String... parameters){
		...
		if (horse != null && horse.getLayer() > 0) {
			...
			if(weared==null){
				...
				//发送装备信息
				MessageUtil.tell_player_message(player, ManagerPool.equipManager.getWearEquipInfo(this,pos));
				//重新计算属性
				...
				MessageUtil.tell_player_message(player, ManagerPool.equipManager.getUnwearEquipInfo(weared, pos));
	...
	public void unuse(Player player, String... parameters){
		...
		if(weared==this){
			...
			//发送卸下装备信息
			MessageUtil.tell_player_message(player, ManagerPool.equipManager.getUnwearEquipInfo(this, pos));
