...
public class Area extends GameObject {
	...
	// 召唤怪列表
	private HashSet<SummonPet> summonpets = new HashSet<SummonPet>();
	...
	public HashSet<SummonPet> getSummonpets() {
		return summonpets;
	}

	public void setSummonpets(HashSet<SummonPet> summonpets) {
