...
public class Map extends GameObject {
	...
	//召唤怪列表
	private HashMap<Long, SummonPet> summonpets = new HashMap<Long, SummonPet>();	
	//跑动怪物列表
	...
	//跑动召唤怪列表
	private HashMap<Long, SummonPet> runningsummonPets = new HashMap<Long, SummonPet>();
	//跑动玩家列表
	...
	public HashMap<Long, SummonPet> getSummonpets() {
		return summonpets;
	}

	public void setSummonpets(HashMap<Long, SummonPet> summonpets) {
		this.summonpets = summonpets;
	}

	public HashMap<Long, SummonPet> getRunningsummonPets() {
		return runningsummonPets;
	}

	public void setRunningsummonPets(HashMap<Long, SummonPet> runningsummonPets) {
		this.runningsummonPets = runningsummonPets;
	}
