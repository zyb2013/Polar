...
public class SystemgrantManager {
	...
	private HashMap<String, System_grantBean> grantmap = new HashMap<String, System_grantBean>();
	...
	public void system_GrantBean_load(){
		...
		HashMap<String, System_grantBean> newgrantmap = new HashMap<String, System_grantBean>();
		while (iter.hasNext()) {
	...
	public synchronized HashMap<String, System_grantBean> getGrantmap() {
		return grantmap;
	}

	public void setGrantmap(HashMap<String, System_grantBean> grantmap) {
	 ...
	 * 
	 */
	public void deleteSystemGrantBean(String id) {
