...
public enum CommonConfig {
	...
	RANK_SKILL_LIST(72),
	//  坐骑升级每次使用的钻石数量
	HORSE_STAGE_UP_GEM_COUNT(100),
	//  钻石驯养坐骑升级增加的经验
	HORSE_STAGE_UP_GEM_EXP(101),
	//TODO  系统参数缺少
	...
	//钻石抽奖1次的价格
	GOLD_RAFFLE_COST_1(106),
	//钻石抽奖10次的价格
	GOLD_RAFFLE_COST_10(107),
	//钻石抽奖50次的价格
	GOLD_RAFFLE_COST_50(108),
	...
	/**
	 * 圣盟成员组队状态,杀怪血量百分比<20%，修正系数
	 */
	KINGCITY_KILLMONSTER20COF(118),
	/**
	 * 圣盟成员组队状态,20%<=杀怪血量<40%，修正系数
	 */
	KINGCITY_KILLMONSTER40COF(119),
	/**
	 * 圣盟成员组队状态,40%<=杀怪血量<70%，修正系数
	 */
	KINGCITY_KILLMONSTER70COF(120),
	/**
	 * 圣盟成员组队状态,70%<=杀怪血量，修正系数
	 */
...
//	AUTOPROHIBIT_SEMBLANCE(146),
	 ...
	 * 低级坐骑丹花费钻石数量
	 */
	HORSE_STAGE_UP_GEM_LOW(201),
	/**
	 * 中级坐骑丹花费钻石数量
	 */
	HORSE_STAGE_UP_GEM_MIDDLE(202),
	/**
	 * 高级坐骑丹花费钻石数量 
	 */
	HORSE_STAGE_UP_GEM_HIGH(203),
	/**
	 * 超级坐骑丹花费钻石数量 
	 */
	HORSE_STAGE_UP_GEM_SUPER(210),
	
	/**
	 * 抽奖获得最大积分
	 */
	GOLD_RAFFLE_MAX_FRACTION(208),
	
	/**
	 * 抽奖获得最小积分
	 */
	GOLD_RAFFLE_MIN_FRACTION(209),
	
	/**
	 * 卓越条目配置
	 */
	ACTIVATION_ATTRIBUTE(213),
