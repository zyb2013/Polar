...
public class MapUtils {
	 ...
	 * @return
	 */
	public static double countDistanceMin(Position pos1, Position pos2) {
		
		return countDistanceMIN(pos1.getX(), pos1.getY(), pos2.getX(), pos2.getY());
	}
...
//		return Math.max(Math.abs(sx - tx), Math.abs(sy - ty));
	 ...
	 * @return
	 */
	public static double countDistanceMIN(short sx, short sy, short tx, short ty) {
		return Math.max(Math.abs(sx - tx), Math.abs(sy - ty));
...
//		return Math.sqrt(Math.pow((sx - tx), 2) + Math.pow((sy - ty), 2));
	...
	public static void main(String args[]) {
		...
		int r1 =  Math.max(Math.abs(sx - tx), Math.abs(sy - ty));

		 double r2 =  Math.sqrt(Math.pow((sx - tx), 2) + Math.pow((sy - ty), 2));
