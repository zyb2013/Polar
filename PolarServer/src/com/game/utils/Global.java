...
public class Global {
	 ...
	 * 千万分比
	 */
	public static int MILLION_PROBABILITY = 10000000;
	/**
	 * 最大等级
	 */
	 ...
	 * 暴击倍率(卓越一击) 
	 */
	public static double CRIT_ZHUOYUE = 1.4;//modified by luminghua
	
	//PERFECT_ATTACKPERCENT  KNOWING_ATTACKPERCENT   IGNORE_ATTACKPERCENT
	public static final int PERFECT_ATTACKPERCENT = 1;
	public static final int KNOWING_ATTACKPERCENT = 2;
	public static final int IGNORE_ATTACKPERCENT  = 3;
	
	public static final int Ice_def = 1;
	public static final int Ray_def = 2;
	public static final int Poison_def  = 3;
	/**
	 * PVP敌对过期时间
	 */
	public static int ENEMY_TIME = 30*60*1000;
	/**
	 * PK值递减时间，每经过时间段，则PK值减1(秒)
	 */
	public static int PK_VALUE_TIME = 60*60;
	/**
	 * 格挡清除debuff间隔
	 */
...
//	public static int BOSS_DIEING = 10000;
	public static int BOSS_DIEING = 0;
	/**
	 * 自动复活时间
	 */
	public static int REVIVE_TIME = 30 * 000;
	/**
	 * 自动回血比例
	 */
	 ...
	 * 包裹最大开格数量
	 */
	public static int MAX_BAG_CELLS = 98;
	
	/**
	 * 仓库默认开启的格子数
	 */
	public static int DEFAULT_STORE_CELLS=49;
	/**
	 * 开启自动开格的格数
	 */
	public static int STORE_AUTOOPEN_CELL_ID=49;
	/**
	 * 仓库最大开格数量
	 */
	public static int MAX_STORE_CELLS = 168;
	 ...
	 * 仓库开启等级
	 */
	public static final byte STORE_NEED_GRADE = 1;
	 ...
	 * 最大携带精魄数
	 */
	public static final int BAG_MAX_SPIRIT=2000000000;
	 ...
	 * 普通怪掉落衰减等级
	 */
	public static int DROP_COMMON_GRADE_LIMIT=70;
	/**
	 * BOSS掉落衰减等级
	 */
	public static int DROP_BOSS_GRADE_LIMIT=70;
	/******************************掉落部分结束*************************************/
	 ...
	 * 世界聊天最小等级
	 */
	public static short CHAT_WORLD_MIN_GRADE=50;
	/**
	 * 普通聊天最小时间间隔(秒)
	 */
	 ...
	 * 击杀怪物有效任务计数所需的伤害比例
	 */
	public static double TASK_EFFECTIVE_DAMAGE_RATIO=0.05;
	...
	/**
	 * 杀怪获得经验者超过这个等级则只有他才算有效击杀
	 */
	public static final int TASK_EXP_GETTER_LEVEL = 100;
	...
	public static int STALL_OPEN_LV=20;
	 ...
	 * 在赤色要塞中的复活保护buff
	 */
	public static int CSYS_PROTECT_FOR_KILLED = 1154;
	/**
	 * 攻城战中的复活保护Buff
	 */
	public static int GCZ_PROTECT_FOR_KILLED = 1189;
	/**
	 * 夜晚挂机保护buff
	 */
	 ...
	 * 
	 */
	public static int PROTECT_IN_BANGZHU = 1113;
	
	
	/**
	 * 夜晚挂机保护buff开始时间(小时)
	 */
	public static int PROTECT_IN_NIGHT_START_HOUR = 1;
	/**
	 * 夜晚挂机保护buff开始时间(分钟)
	 */
	public static int PROTECT_IN_NIGHT_START_MINUTE = 0;
	/**
	 * 夜晚挂机保护buff结束时间
	 */
	 ...
	 * 主城地图id
	 */
	public static final int MAIN_CITY_MAP_ID = 100001;
	
	/**
	 * 洗恶符道具
	 */
	public static final int XI_E_FU_ITEM = 700049;
	
	/**
	 * 通用引用标识
	 */
	public static final Object REFER_OBJECT = new Object();
