...
//	}
	...
	/**
	 * xuliang add
	 * 获得提示类型，多个类型将被拼成一个 long
	 * 每三位为一个类型
	 */
	public static String getNotifyType(byte... notifys){
		String notify = "";
	...
	public static void notify_player(Player me, Notifys type, String message, String... values) {
		notify_player(me, type.getValue() + "", message, values);
	}
		
	public static void notify_player(Player me, String type, String message, String... values) {
	...
	public static void notify_player(Player me, Notifys type, String message, List<GoodsInfoRes> iteminfolist,int subtype,String... values){
		notify_player(me, type.getValue() + "", message, iteminfolist, subtype, values);
	}
	
	public static void notify_player(Player me, String type, String message, List<GoodsInfoRes> iteminfolist,int subtype,String... values){
		PersonalNoticeMessage msg = new PersonalNoticeMessage();
		msg.setType(type);
		msg.setContent(message);
	...
	public static void notify_map(Map destmap, Notifys type, String message, String... values){
		notify_map(destmap, type.getValue() + "", message, values);
	}
	
	public static void notify_map(Map destmap, String type, String message, String... values) {
		PersonalNoticeMessage msg = new PersonalNoticeMessage();
		msg.setType(type);
		msg.setContent(message);
		if (values != null) {
...
//	}
	...
	public static void notify_All_player(String type, String message, String... values) {
		PersonalNoticeMessage msg = new PersonalNoticeMessage();
		msg.setType(type);
		msg.setContent(message);
		if (values != null) {
	...
	public static void notify_All_player(String type, String message, List<GoodsInfoRes> iteminfolist,int subtype,String... values) {
		PersonalNoticeMessage msg = new PersonalNoticeMessage();
		msg.setType(type);
		msg.setContent(message);
		if (iteminfolist != null) {
	...
	public static void notify_All_Activity(Notifys type, int activityid, String message, String... values) {
		notify_All_Activity(type.getValue() + "", activityid, message, values);
	}
	
	public static void notify_All_Activity(String type, int activityid, String message, String... values) {
