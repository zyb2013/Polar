...
public class EquipInfo extends Bean {
	...
	public boolean write(IoBuffer buf){
		...
		//物品过期时间
		writeInt(buf, this.itemLosttime);
		writeInt(buf, fightPower);
		writeInt(buf,this.attributeCount);
		return true;
	}
	...
	public boolean read(IoBuffer buf){
		...
		//物品过期时间
		this.itemLosttime = readInt(buf);
		this.fightPower = readInt(buf);
		this.attributeCount  = readInt(buf);
		return true;
	}
	 ...
	 * set 物品过期时间
	 */
	public void setItemLosttime(int itemLosttime){
