...
public class ReqTaskFinshMessage extends Message{
	...
	public boolean write(IoBuffer buf){
		...
		writeByte(buf,this.isDoubleRewards);
		return true;
	}
	...
	public boolean read(IoBuffer buf){
		...
		this.isDoubleRewards = readByte(buf);
		return true;
	}
	
	public byte getIsDoubleRewards() {
		return isDoubleRewards;
	}

	public void setIsDoubleRewards(byte isDoubleRewards) {
		this.isDoubleRewards = isDoubleRewards;
	}
