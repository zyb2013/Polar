...
public class HorseLog extends BaseLogBean {
	...
	private int yuanbao;			//道具不足的时候购买道具花费钻石
	private int yblessvalue;			//原祝福值
	private int newblessvalue;		//最后总的祝福值
	*/
	
	private long playerId;		//玩家ID
	private int curlayer;		//当前等级
	private int dayupnum ;		//升级次数
	private int isupsuccess;	//是否升级成功，0失败，1成功
	private int itemid;			//扣道具ID
	private int itemnum;		//道具数量
	private int zuanshi;		//一键升阶消耗的钻石数量
	private int sid;
	...
	@Log(logField="curlayer",fieldType="integer")
	...
	*/
	...
	@Log(logField="zuanshi",fieldType="integer")
