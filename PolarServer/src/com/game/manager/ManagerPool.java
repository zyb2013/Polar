...
import com.game.casting.manager.CastingManager;
...
import com.game.pray.manager.PrayManager;
import com.game.protect.manager.ProtectManager;
...
public class ManagerPool {
	 ...
	 * 背包管理类
	 */
	public static BackpackManager backpackManager = BackpackManager
			.getInstance();
	/**
	 * 仓库管理类
	 */
	 ...
	 * 快捷管理类
	 */
	public static ShortCutManager shortCutManager = ShortCutManager
			.getInstance();
	/**
	 * 战斗管理类
	 */
	 ...
	 * 冷却管理类
	 */
	public static CooldownManager cooldownManager = CooldownManager
			.getInstance();
	/**
	 * 聊天管理类
	 */
	...
	// 点绛唇管理类
	// panic god public static DianjiangchunManager dianjiangchunManager =
	 ...
	 * 召唤怪操作管理
	 */
	public static SummonPetOptManager summonpetOptManager = SummonPetOptManager.getInstance();
	
	/**
	 * 召唤怪信息管理
	 */
	public static SummonPetInfoManager summonpetInfoManager = SummonPetInfoManager.getInstance();
	/**
	 * 军衔管理类
	 */
	 ...
	 * 玩家属性管理类
	 */
	public static PlayerAttributeManager playerAttributeManager = PlayerAttributeManager
			.getInstance();
	/**
	 * 组队管理类
	 */
	 ...
	 * 交易管理类
	 */
	public static TransactionsManager transactionsManager = TransactionsManager
			.getInstance();
	/**
	 * 摆摊管理类
	 */
	 ...
	 * 定时任务管理类
	 */
	public static SchedularManager schedularManager = SchedularManager
			.getInstance();
	/**
	 * 脚本管理类
	 */
	...
	// 日志管理类
	// panic god public static LogService logManager=LogService.getInstance();

	// panic god public static StrutsCenter
	// strutscenter=StrutsCenter.getInstance();
	/**
	 * 更新类日志管理类
	 */
	public static UpdateLogService updateLogService = UpdateLogService
			.getInstance();

	/**
	 * 邮件管理类
	 */
	public static MailServerManager mailServerManager = MailServerManager
			.getInstance();
	/**
	 * 龙元心法管理
	 */
	public static LongYuanManager longyuanManager = LongYuanManager
			.getInstance();
	/**
	 * 仇恨管理
	 */
	 ...
	 * 前端游戏设置面板管理
	 */
	public static SetupMenuManager setupMenuManager = SetupMenuManager
			.getInstance();
	/**
	 * 坐骑管理类
	 */
	 ...
	 * 角色打座管理
	 */
	public static PlayerDaZuoManager dazuoManager = PlayerDaZuoManager
			.getInstacne();
	/**
	 * 副本管理
	 */
	 ...
	 * 装备强化升阶管理
	 */
	public static EquipStrengManager equipstrengManager = EquipStrengManager
			.getInstance();
	/**
	 * 前端外挂设置管理
	 */
	 ...
	 * 活动系统管理
	 */
	public static ActivitiesManager activitiesManager = ActivitiesManager
			.getInstance();
	/**
	 * 玩家随机名字
	 */
	public static PlayerRandomNameManager randomNameManager = PlayerRandomNameManager
			.getInstance();
	/**
	 * 灵树系统管理
	 */
	public static SpiritTreeManager spiritTreeManager = SpiritTreeManager
			.getInstance();
	/**
	 * RES版本管理
	 */
	 ...
	 * 副本奖励管理
	 */
	public static ZonesFlopManager zonesFlopManager = ZonesFlopManager
			.getInstance();
	/**
	 * 多人副本管理
	 */
	public static ZonesTeamManager zonesTeamManager = ZonesTeamManager
			.getInstance();
	/**
	 * 连斩管理
	 */
	 ...
	 * 挑战管理
	 */
	public static ChallengeManager challengeManager = ChallengeManager
			.getInstance();
	/**
	 * GM权限管理
	 */
	public static GMCommandManager gmcommandManager = GMCommandManager
			.getInstance();
	/**
	 * 王城争霸战管理
	 */
	 ...
	 * 服务器级统计
	 */
	// panic god public static ServerCountManager
	// serverCountManager=ServerCountManager.getInstance();
	/**
	 * 场景物件
	 */
	public static SceneobjManager sceneobjManager = SceneobjManager
			.getInstance();
	/**
	 * 场景陷阱点
	 */
	 ...
	 * 战盟领地争夺战
	 */
	public static GuildFlagManager guildFlagManager = GuildFlagManager
			.getInstance();
	/**
	 * 战盟管理
	 */
	public static GuildServerManager guildServerManager = GuildServerManager
			.getInstance();
	/**
	 * 弓箭管理
	 */
	 ...
	 * 签到工资管理
	 */
	public static SignWageManager signWageManager = SignWageManager
			.getInstance();
	/**
	 * 收集管理
	 */
	 ...
	 * 骑战兵器管理
	 */
	public static HorseWeaponManager horseWeaponManager = HorseWeaponManager
			.getInstance();
	/**
	 * 宝箱幸运轮盘管理
	 */
	public static ChestBoxManager chestBoxManager = ChestBoxManager
			.getInstance();
	/**
	 * 比武岛管理
	 */
	 ...
	 * 暗器管理
	 */
	public static HiddenWeaponManager hiddenWeaponManager = HiddenWeaponManager
			.getInstance();
	/**
	 * 婚姻系统管理
	 */
	public static MarriageManager marriageManager = MarriageManager
			.getInstance();
	/**
	 * 跨服报名管理
	 */
	public static EnterManager enterManager = EnterManager.getInstance();
	/**
	 * 二级密码钻石保护管理
	 */
	public static ProtectManager protectManager = ProtectManager.getInstance();

	public static EquipAttributeAddManager equipAttributeAddManager=EquipAttributeAddManager.getInstance();
	
	public static EquipComposeManager euipComposeManager=EquipComposeManager.getInstance();
	
	/**
	 * 祈愿管理
	 */
	public static PrayManager prayManager = PrayManager.getInstance();
	
	/**
	 * 钱庄管理
	 */
	public static BankManager bankManager = BankManager.getInstance();
	
	/**
	 * 钻石抽奖管理
	 */
	public static GoldRaffleManager goldRaffleManager = GoldRaffleManager.getInstance(); 
	
	
	public static CsysManger csysManger = CsysManger.getInstance();
	 ...
	 * date   2013.12.26
	 */
	public static LivenessManager livenessManager = LivenessManager.getInstance();
