...
public class ServerHeartConfigXmlLoader {

	private static Logger log = Logger.getLogger(ServerHeartConfigXmlLoader.class);
	
	public ServerHeartConfig load(String file){
		ServerHeartConfig config = new ServerHeartConfig();
		try{
	...
	public static void main(String[] args){
		ServerHeartConfig ck = new ServerHeartConfig();
		ck = new ServerHeartConfigXmlLoader().load("server-config/server-heart-config.xml");
