...
//TODO 无用，正式开区删除
public class TmpYuanbaoLogData extends GameObject {
	 ...
	 * @param yuanbaonum
	 */
//	public void setTmpYuanbaoLog(String name,long rid ,byte type , ItemInfo iteminfo,int num,int goldnum,int yuanbaonum){
