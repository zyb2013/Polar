...
public class SiegeSMS {
	...
	private int conKill;	//连杀
	
	private int maxConKill;	//最高连杀
	
	
	public int getConKill() {
		return conKill;
	}
	public void setConKill(int conKill) {
		this.conKill = conKill;
	}
	public int getMaxConKill() {
		return maxConKill;
	}
	public void setMaxConKill(int maxConKill) {
		this.maxConKill = maxConKill;
	}
	...
	public CountryTopInfo getinfo(){
		...
		countryTopInfo.setConKill(this.getConKill());
		countryTopInfo.setMaxConKill(this.getMaxConKill());
