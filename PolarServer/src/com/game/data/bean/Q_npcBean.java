...
public class Q_npcBean {
	...
	//采集获得物品
	private String q_acquisition_item;
	...
	//采集完成任务
	private String q_acquisition_task;
	...
	public void setQ_shop(String q_shop) {
		this.q_shop = q_shop;
	}

	/**
	 * get NPC传送序列（文字描述|MAPid,X,Y,半径|等级|钻石=Y金币=G|价格;文字描述|MAPid,X,Y,半径|等级|钻石=Y金币=G|价格）
	 * @return 
	 */
	...
	/**
	 * set NPC传送序列（文字描述|MAPid,X,Y,半径|等级|钻石=Y金币=G|价格;文字描述|MAPid,X,Y,半径|等级|钻石=Y金币=G|价格）
	 */
	...
	public String getQ_acquisition_item() {
		return q_acquisition_item;
	}

	public void setQ_acquisition_item(String q_acquisition_item) {
	 ...
	 * @return 
	 */
	public String getQ_acquisition_task(){
	 ...
	 * set 采集完成任务
	 */
	public void setQ_acquisition_task(String q_acquisition_task){
