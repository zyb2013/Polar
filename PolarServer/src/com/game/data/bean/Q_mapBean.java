...
public class Q_mapBean {
	...
	/**
	 * get 死亡随机回城坐标[[364,183],[364,182]]这样的格式
	 * @return 
	 */
	...
	/**
	 * get 退出随机回城坐标（x_y;x_y）[[364,183],[364,182]]这样的格式
	 * @return 
	 */
	 ...
	 * 是否增加PK值（1是，0否）
	 */
	public int getQ_map_pkpoint(){
		return this.q_map_pkpoint;
	}
	
	/**
	 * 是否增加PK值（1是，0否）
	 */
	public void setQ_map_pkpoint(int q_map_pkpoint){
		this.q_map_pkpoint = q_map_pkpoint;
	}
}