 ...
 * Q_horseweapon Bean
 */
public class Q_horseweaponBean {
	...
	//场景中骑兵用造型资源编号
	private int q_res_sceneid;
	
	//场景骑兵光效资源
	private int q_res_lightid;
	 ...
	 * @return 
	 */
	public int getQ_res_sceneid(){
		return q_res_sceneid;
	}
	
	/**
	 * set 场景中骑兵用造型资源编号
	 */
	public void setQ_res_sceneid(int q_res_sceneid){
		this.q_res_sceneid = q_res_sceneid;
	}
	 ...
	 * @return 
	 */
	public int getQ_res_lightid(){
		return q_res_lightid;
	}
	
	/**
	 * set 场景骑兵光效资源
	 */
	public void setQ_res_lightid(int q_res_lightid){
		this.q_res_lightid = q_res_lightid;
	}
