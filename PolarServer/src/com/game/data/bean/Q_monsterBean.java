...
public class Q_monsterBean {
	...
	private int q_element_defence_ice;
	private int q_element_defence_bolt;
	private int q_element_defence_bane;
	...
	public int getQ_element_defence_ice() {
		return q_element_defence_ice;
	}

	public void setQ_element_defence_ice(int q_element_defence_ice) {
		this.q_element_defence_ice = q_element_defence_ice;
	}

	public int getQ_element_defence_bolt() {
		return q_element_defence_bolt;
	}

	public void setQ_element_defence_bolt(int q_element_defence_bolt) {
		this.q_element_defence_bolt = q_element_defence_bolt;
	}

	public int getQ_element_defence_bane() {
		return q_element_defence_bane;
	}

	public void setQ_element_defence_bane(int q_element_defence_bane) {
		this.q_element_defence_bane = q_element_defence_bane;
	}
	...
	/**
	 * get [{"类型":1,"间隔":10000,"几率":10000,"说话":"怪物计时器触发","预警":0,"触发":10002_2,"对象":1},{"类型":2,"几率":5000,"说话":"怪物攻击触发","预警":0,"触发":10012_2,"对象":1},
	 * {"类型":3,"血量":5,"几率":10000,"说话":"怪物掉血触发2","预警":0,"触发":10003_3,"对象":1}] 
	 * //新加类型为4，进入这个血量范围，就把这个当作默认技能() {"类型":4,"血量":5,"几率":10000,"说话":"怪物掉血触发2","预警":0,"触发":10003_3,"对象":1}
	 * @return 
	 */
	...
	/**
	 * set 
 [{"类型":1,"间隔":10000,"几率":10000,"说话":"怪物计时器触发","预警":0,"触发":10002_2,"对象":1},{"类型":2,"几率":5000,"说话":"怪物攻击触发","预警":0,"触发":10012_2,"对象":1},
	 * {"类型":3,"血量":5,"几率":10000,"说话":"怪物掉血触发2","预警":0,"触发":10003_3,"对象":1}] 
	 * //新加类型为4，进入这个血量范围，就把这个当作默认技能() {"类型":4,"血量":5,"几率":10000,"说话":"怪物掉血触发2","预警":0,"触发":10003_3,"对象":1}
 */
