...
public class Q_clone_activityBean {
	...
	//副本所在层
	private int q_dungeon_level;
	
	//副本所在关卡
	private int q_dungeon_stage;
	...
	//通关奖励(-1到-5)和ITEM表里的对应(-1金币，-2钻石，-3真气，-4经验  -5绑定钻石 -6精魄)
	//   格式 ：  物品ID_数量;物品ID_数量;物品ID_数量;
	private String q_reward;
	
	//副本时间评价（填写时间，精确到毫秒，如果玩家通关时间小于填写时间，则获得一颗星）
	private String q_time_evaluate;
	...
	//副本进入间隔  无论是否完成 进入开始 计算
	private int q_wait_time;
	
	//首通奖励
	private String q_first_award;
		
		
	
	public int getQ_wait_time() {
		return q_wait_time;
	}

	public void setQ_wait_time(int q_wait_time) {
		this.q_wait_time = q_wait_time;
	}
	...
	/**
	 * get 通关奖励(-1到-5)和ITEM表里的对应(-1金币，-2钻石，-3真气，-4经验  -5绑定钻石)
	 * @return 
	 */
	...
	/**
	 * set 通关奖励(-1到-5)和ITEM表里的对应(-1金币，-2钻石，-3真气，-4经验  -5绑定钻石)
	 */
	 ...
	 * @return 
	 */
	public String getQ_time_evaluate(){
	 ...
	 */
	public void setQ_time_evaluate(String q_time_evaluate){
	...
	public String getQ_first_award() {
		return q_first_award;
	}

	public void setQ_first_award(String q_first_award) {
		this.q_first_award = q_first_award;
	}
	
	public int getQ_dungeon_level() {
		return q_dungeon_level;
	}

	public void setQ_dungeon_level(int q_dungeon_level) {
		this.q_dungeon_level = q_dungeon_level;
	}

	public int getQ_dungeon_stage() {
		return q_dungeon_stage;
	}

	public void setQ_dungeon_stage(int q_dungeon_stage) {
		this.q_dungeon_stage = q_dungeon_stage;
	}
}