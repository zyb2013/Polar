...
public class Q_transferBean {
	 ...
	 * @return
	 */
	public int getQ_transfer_money(){
		return q_transfer_money;
	}
	
	/*
	 * set 传送到该地图所需金币
	 */
	public void setQ_transfer_money(int q_transfer_money){
		this.q_transfer_money = q_transfer_money;
	}
