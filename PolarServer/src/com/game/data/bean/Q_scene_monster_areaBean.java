...
public class Q_scene_monster_areaBean {
	...
	//恶魔广场 单独使用的 刷怪  ID 集合
	private String q_add_monster_model;
	
	public String getQ_add_monster_model() {
		return q_add_monster_model;
	}

	public void setQ_add_monster_model(String q_add_monster_model) {
		this.q_add_monster_model = q_add_monster_model;
	}
