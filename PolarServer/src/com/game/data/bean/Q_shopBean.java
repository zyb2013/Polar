...
public class Q_shopBean {
	...
	//允许使用的货币类型类型（1游戏币，2钻石，4绑定钻石，6钻石与绑定钻石可购买，7三种货币均可购买）
	private String q_money_type;
	...
	/**
	 * get 允许使用的货币类型类型（1游戏币，2钻石，4绑定钻石，6钻石与绑定钻石可购买，7三种货币均可购买）
	 * @return 
	 */
	public String getQ_money_type(){
		return q_money_type;
	}
	
	/**
	 * set 允许使用的货币类型类型（1游戏币，2钻石，4绑定钻石，6钻石与绑定钻石可购买，7三种货币均可购买）
	 */
	public void setQ_money_type(String q_money_type){
