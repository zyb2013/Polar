...
public class Q_petinfoBean {
	...
	//每日亲热次数
	private int q_qr_daycount;
	
	//普通亲热增加攻击
	private int q_qr_addattack;
	
	//普通亲热增加防御
	private int q_qr_adddefence;
	
	//普通亲热增加暴击
	private int q_qr_addcrit;
	
	//普通亲热增加闪避
	private int q_qr_adddodge;
	
	//普通亲热增加生命
	private int q_qr_addhp;
	
	//普通亲热增加魔法值
	private int q_qr_firstmp;
	
	//首次亲热增加经验脚本编号
	private int q_firstqr_exp_script;
	
	//普通亲热增加经验脚本编号
	private int q_qr_exp_script;
	
	//亲热消耗真气
	private int q_qr_resume_zhenqi;
	
	//亲热消耗游戏金币
	private int q_qr_resume_gold;
	
	//亲热消耗材料编号
	private String q_qr_resumeitem;
	
	//亲热冷却时长（毫秒）
	private int q_qr_cd;
	
	//最大亲热次数
	private int q_qr_countmax;
	 ...
	 * @return 
	 */
	public int getQ_qr_daycount(){
		return q_qr_daycount;
	}
	
	/**
	 * set 每日亲热次数
	 */
	public void setQ_qr_daycount(int q_qr_daycount){
		this.q_qr_daycount = q_qr_daycount;
	}
	 ...
	 * @return 
	 */
	public int getQ_qr_addattack(){
		return q_qr_addattack;
	}
	
	/**
	 * set 普通亲热增加攻击
	 */
	public void setQ_qr_addattack(int q_qr_addattack){
		this.q_qr_addattack = q_qr_addattack;
	}
	 ...
	 * @return 
	 */
	public int getQ_qr_adddefence(){
		return q_qr_adddefence;
	}
	
	/**
	 * set 普通亲热增加防御
	 */
	public void setQ_qr_adddefence(int q_qr_adddefence){
		this.q_qr_adddefence = q_qr_adddefence;
	}
	 ...
	 * set 普通亲热增加暴击
	 */
	public void setQ_qr_addcrit(int q_qr_addcrit){
		this.q_qr_addcrit = q_qr_addcrit;
	}
	 ...
	 * @return 
	 */
	public int getQ_qr_adddodge(){
		return q_qr_adddodge;
	}
	
	/**
	 * set 普通亲热增加闪避
	 */
	public void setQ_qr_adddodge(int q_qr_adddodge){
		this.q_qr_adddodge = q_qr_adddodge;
	}
	 ...
	 * set 普通亲热增加生命
	 */
	public void setQ_qr_addhp(int q_qr_addhp){
		this.q_qr_addhp = q_qr_addhp;
	}
	 ...
	 * set 普通亲热增加魔法值
	 */
	public void setQ_qr_firstmp(int q_qr_firstmp){
		this.q_qr_firstmp = q_qr_firstmp;
	}
	 ...
	 * @return 
	 */
	public int getQ_firstqr_exp_script(){
		return q_firstqr_exp_script;
	}
	
	/**
	 * set 首次亲热增加经验脚本编号
	 */
	public void setQ_firstqr_exp_script(int q_firstqr_exp_script){
		this.q_firstqr_exp_script = q_firstqr_exp_script;
	}
	 ...
	 * @return 
	 */
	public int getQ_qr_exp_script(){
		return q_qr_exp_script;
	}
	
	/**
	 * set 普通亲热增加经验脚本编号
	 */
	public void setQ_qr_exp_script(int q_qr_exp_script){
		this.q_qr_exp_script = q_qr_exp_script;
	}
	 ...
	 * @return 
	 */
	public int getQ_qr_resume_zhenqi(){
		return q_qr_resume_zhenqi;
	}
	
	/**
	 * set 亲热消耗真气
	 */
	public void setQ_qr_resume_zhenqi(int q_qr_resume_zhenqi){
		this.q_qr_resume_zhenqi = q_qr_resume_zhenqi;
	}
	 ...
	 * @return 
	 */
	public int getQ_qr_resume_gold(){
		return q_qr_resume_gold;
	}
	
	/**
	 * set 亲热消耗游戏金币
	 */
	public void setQ_qr_resume_gold(int q_qr_resume_gold){
		this.q_qr_resume_gold = q_qr_resume_gold;
	}
	 ...
	 * @return 
	 */
	public String getQ_qr_resumeitem(){
		return q_qr_resumeitem;
	}
	
	/**
	 * set 亲热消耗材料编号
	 */
	public void setQ_qr_resumeitem(String q_qr_resumeitem){
		this.q_qr_resumeitem = q_qr_resumeitem;
	}
	 ...
	 * set 亲热冷却时长（毫秒）
	 */
	public void setQ_qr_cd(int q_qr_cd){
		this.q_qr_cd = q_qr_cd;
	}
	 ...
	 * @return 
	 */
	public int getQ_qr_countmax(){
		return q_qr_countmax;
	}
	
	/**
	 * set 最大亲热次数
	 */
	public void setQ_qr_countmax(int q_qr_countmax){
		this.q_qr_countmax = q_qr_countmax;
	}
