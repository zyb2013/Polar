...
public class Q_characterBean {
	...
	//自动回复生命值
	private int q_auto_recover_hp;
	
	//自动回复魔法值值
	private int q_auto_recover_mp;
	
	//自动回复体力值
	private int q_auto_recover_sp;
	
	//最大物理攻击'
	private int q_phyattack_max;
	//最小物理攻击
	private int q_phyattack_min;
	//最大魔法攻击
	private int q_magicattack_max;
	//最小魔法攻击
	private int q_magicattack_min;
	//攻击成功率
	private int q_hit;
	//参照经验值
	private int q_rexp;
	//参照游戏币
	private int q_remoney;
	...
	public int getQ_phyattack_max() {
		return q_phyattack_max;
	}

	public void setQ_phyattack_max(int q_phyattack_max) {
		this.q_phyattack_max = q_phyattack_max;
	}

	public int getQ_phyattack_min() {
		return q_phyattack_min;
	}

	public void setQ_phyattack_min(int q_phyattack_min) {
		this.q_phyattack_min = q_phyattack_min;
	}

	public int getQ_magicattack_max() {
		return q_magicattack_max;
	}

	public void setQ_magicattack_max(int q_magicattack_max) {
		this.q_magicattack_max = q_magicattack_max;
	}

	public int getQ_magicattack_min() {
		return q_magicattack_min;
	}

	public void setQ_magicattack_min(int q_magicattack_min) {
		this.q_magicattack_min = q_magicattack_min;
	}
	...
	public int getQ_rexp() {
		return q_rexp;
	}

	public void setQ_rexp(int q_rexp) {
		this.q_rexp = q_rexp;
	}

	public int getQ_remoney() {
		return q_remoney;
	}

	public void setQ_remoney(int q_remoney) {
		this.q_remoney = q_remoney;
	}
	 ...
	 * @return 
	 */
	public int getQ_auto_recover_hp(){
		return q_auto_recover_hp;
	}
	
	/**
	 * set 自动回复生命值
	 */
	public void setQ_auto_recover_hp(int q_auto_recover_hp){
		this.q_auto_recover_hp = q_auto_recover_hp;
	}
	 ...
	 * @return 
	 */
	public int getQ_auto_recover_mp(){
		return q_auto_recover_mp;
	}
	
	/**
	 * set 自动回复魔法值值
	 */
	public void setQ_auto_recover_mp(int q_auto_recover_mp){
		this.q_auto_recover_mp = q_auto_recover_mp;
	}
	 ...
	 * @return 
	 */
	public int getQ_auto_recover_sp(){
		return q_auto_recover_sp;
	}
	
	/**
	 * set 自动回复体力值
	 */
	public void setQ_auto_recover_sp(int q_auto_recover_sp){
		this.q_auto_recover_sp = q_auto_recover_sp;
	}
