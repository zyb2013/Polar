...
public class Q_skill_modelBean {
	...
	// 技能类型（0普通技能，1火墙类型，2是冲锋，3是地裂斩&旋风斩，4是雷, 5是自爆人, 6有时间的召唤怪）
	...
	// //////////////新加字段////////////////////////////////
	// 伤害类型(0=物理 1=魔法)
	private int q_hurttype;
	// 触发类型条件(技能ID）
	private int q_passive_condition;
	// 技能元素属性（0=冰 1=雷 2=毒 3=无属性（指定概率））
	private int q_skill_elementtype;
	// 冰攻加成
	private int q_element_ice;
	// 雷攻加成
	private int q_element_Lightning;
	// 毒攻加成
	private int q_element_bane;
	// 是否攻击时瞬移
	private int q_attck_istelesport;
	// 发动时间
	private int q_acttime;
	// 职业要求
	private String q_job;
	// 是否可在瞬移时施法
	private int q_telesport_ismagic;
	// 技能攻击力加成(%)
	private int q_skill_attack;
	// 召唤兽(格式：召唤兽ID_数量_时间（秒）_属性百分比；召唤兽ID_数量_属性百分比_时间（秒）_属性百分比)  //召唤兽继承召唤主人的属性百分比
	private String q_animal_id;
	// 受击硬直追加
	private int q_hit_crick;
	// 击飞水平位移（正常） 决定了技能命中目标后，目标未死亡情况下击飞的水平位移
	private int q_whirlwind_nor;
	//变身技能(id 为对应变身的buff模板ID),没有变身默认为0
	private int q_shapechange_buffid;
	 ...
	 * get 击飞水平位移（正常）
	 */
	public int getQ_whirlwind_nor() {
		return q_whirlwind_nor;
	}

	/**
	 * set 击飞水平位移（正常）
	 */
	public void setQ_whirlwind_nor(int q_whirlwind_nor) {
		this.q_whirlwind_nor = q_whirlwind_nor;
	}

	/**
	 * get 伤害类型(0=物理 1=魔法)
	 */
	public int getQ_hurttype() {
		return q_hurttype;
	}
	 ...
	 * set 伤害类型(0=物理 1=魔法)
	 */
	public void setQ_hurttype(int q_hurttype) {
		this.q_hurttype = q_hurttype;
	}

	/**
	 * get 触发类型条件(技能ID）
	 */
	public int getQ_passive_condition() {
		return q_passive_condition;
	}

	/**
	 * set 触发类型条件(技能ID）
	 */
	public void setQ_passive_condition(int q_passive_condition) {
		this.q_passive_condition = q_passive_condition;
	}

	/**
	 * get 技能元素属性（0=冰 1=雷 2=毒 3=无属性（指定概率））
	 */
	public int getQ_skill_elementtype() {
		return q_skill_elementtype;
	}

	/**
	 * set 技能元素属性（0=冰 1=雷 2=毒 3=无属性（指定概率））
	 */
	public void setQ_skill_elementtype(int q_skill_elementtype) {
		this.q_skill_elementtype = q_skill_elementtype;
	}

	/**
	 * get 冰攻加成
	 */
	public int getQ_element_ice() {
		return q_element_ice;
	}

	/**
	 * set 冰攻加成
	 */
	public void setQ_element_ice(int q_element_ice) {
		this.q_element_ice = q_element_ice;
	}

	/**
	 * get 雷攻加成
	 */
	public int getQ_element_Lightning() {
		return q_element_Lightning;
	}

	/**
	 * set 雷攻加成
	 */
	public void setQ_element_Lightning(int q_element_Lightning) {
		this.q_element_Lightning = q_element_Lightning;
	}

	/**
	 * get 毒攻加成
	 */
	public int getQ_element_bane() {
		return q_element_bane;
	}

	/**
	 * set 毒攻加成
	 */
	public void setQ_element_bane(int q_element_bane) {
		this.q_element_bane = q_element_bane;
	}

	/**
	 * get 是否攻击时瞬移
	 */
	public int getQ_attck_istelesport() {
		return q_attck_istelesport;
	}

	/**
	 * set 是否攻击时瞬移
	 */
	public void setQ_attck_istelesport(int q_attck_istelesport) {
		this.q_attck_istelesport = q_attck_istelesport;
	}

	/**
	 * get 发动时间
	 */
	public int getQ_acttime() {
		return q_acttime;
	}
	 ...
	 * set 发动时间
	 */
	public void setQ_acttime(int q_acttime) {
		this.q_acttime = q_acttime;
	}
	 ...
	 * get 是否可在瞬移时施法
	 */
	public int getQ_telesport_ismagic() {
		return q_telesport_ismagic;
	}

	/**
	 * set 是否可在瞬移时施法
	 */
	public void setQ_telesport_ismagic(int q_telesport_ismagic) {
		this.q_telesport_ismagic = q_telesport_ismagic;
	}

	/**
	 * get 技能攻击力加成(%)
	 */
	public int getQ_skill_attack() {
		return q_skill_attack;
	}

	/**
	 * set 技能攻击力加成(%)
	 */
	public void setQ_skill_attack(int q_skill_attack) {
		this.q_skill_attack = q_skill_attack;
	}

	/**
	 * get 召唤兽ID
	 */
	public String getQ_animal_id() {
		return q_animal_id;
	}
	 ...
	 * set 召唤兽ID
	 */
	public void setQ_animal_id(String q_animal_id) {
		this.q_animal_id = q_animal_id;
	}

	/**
	 * get 受击硬直追加
	 */
	public int getQ_hit_crick() {
		return q_hit_crick;
	}
	 ...
	 * set 受击硬直追加
	 */
	public void setQ_hit_crick(int q_hit_crick) {
		this.q_hit_crick = q_hit_crick;
	}
	...
	/**
	 * get 触发方式（0不是被动触发，1在攻击时触发，2在挨打时触发,3攻击与挨打时都触发,4攻击前触发,5被攻击前触发，6侍宠攻击时触发，7
	 * 侍宠被攻击时触发，8侍宠攻击、被攻击均触发，9主角死亡时触发，10暗器次数触发）
	 * 
	 * @return
	 */
	...
	/**
	 * set 触发方式（0不是被动触发，1在攻击时触发，2在挨打时触发,3攻击与挨打时都触发,4攻击前触发,5被攻击前触发，6侍宠攻击时触发，7
	 * 侍宠被攻击时触发，8侍宠攻击、被攻击均触发，9主角死亡时触发，10暗器次数触发）
	 */
	...
	/**
	 * get 技能类型（0普通技能，1火墙类型，2是冲锋，3是地裂斩&旋风斩，4是雷， 5是自爆人）
	 * 
	 * @return
	 */
	...
	/**
	 * set 技能类型（0普通技能，1火墙类型，2是冲锋，3是地裂斩&旋风斩，4是雷）
	 */
	 ...
	 * set变身技能ID（BUFF模板ID）
	 */
	public int getQ_shapechange_buffid() {
		return q_shapechange_buffid;
	}

	public void setQ_shapechange_buffid(int q_shapechange_buffid) {
		this.q_shapechange_buffid = q_shapechange_buffid;
	}
}