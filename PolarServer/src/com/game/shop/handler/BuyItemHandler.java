...
public class BuyItemHandler extends Handler{
	...
	public void action(){
		try{
			...
			ManagerPool.shopManager.buyItem((Player)this.getParameter(), msg.getNpcId(), msg.getSellId(), msg.getNum(), msg.getCostType(),msg.getCoin(),msg.getBindgold(),msg.getGold(),msg.getSouldiamond());
