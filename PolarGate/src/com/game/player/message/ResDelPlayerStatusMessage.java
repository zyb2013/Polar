 ...
 * 返回给网关端删除角色消息消息
 */
public class ResDelPlayerStatusMessage extends Message{
	...
	//类型： 0人物不存在（或已删），1删除成功，2删除失败（删除角色达到4人），3需要退出战盟才可以删除
	private byte type;
	...
	/**
	 * get 类型： 0人物不存在（或已删），1删除成功，2删除失败（删除角色达到4人），3需要退出战盟才可以删除
	 * @return 
	 */
	public byte getType(){
		return type;
	...
	/**
	 * set 类型： 0人物不存在（或已删），1删除成功，2删除失败（删除角色达到4人），3需要退出战盟才可以删除
	 */
