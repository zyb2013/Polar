...
public class MessageUtil {
	 ...
	 * @throws IOException 
	 */
	public static void tell_player_message(Player player, Message message) throws IOException{
	 ...
	 * @throws IOException 
	 */
	public static void tell_world_message(Message message) throws IOException{
		//全体发送
