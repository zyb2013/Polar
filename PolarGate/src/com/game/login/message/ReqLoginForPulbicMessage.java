 ...
 * 登陆消息
 */
public class ReqLoginForPulbicMessage extends Message{
	...
	public String toString(){
		...
		//角色id
		if(this.playerId!=null) buf.append("playerId:" + playerId.toString() +",");
