package datasets.bean{
	 ...
	 * Q_horseweapon
	 */
	public class Q_horseweapon extends Bean{
		...
		//场景中骑兵用造型资源编号
		private var _q_res_sceneid: int;
		
		//场景骑兵光效资源
		private var _q_res_lightid: int;
		
		//骑兵技能ID（0：无技能，组合技能1的ID;组合技能2的ID;组合技能3的ID;组合技能4的ID;组合技能5的ID;）
		...
		override protected function reading(): Boolean{
			...
			//场景中骑兵用造型资源编号
			_q_res_sceneid = readInt();
			//场景骑兵光效资源
			_q_res_lightid = readInt();
			//骑兵技能ID（0：无技能，组合技能1的ID;组合技能2的ID;组合技能3的ID;组合技能4的ID;组合技能5的ID;）
			_q_skillid = readInt();
			//成长潜力值
		 ...
		 * @return 
		 */
		public function get q_res_sceneid(): int{
			return _q_res_sceneid;
		}
		
		/**
		 * set 场景中骑兵用造型资源编号
		 */
		public function set q_res_sceneid(value: int): void{
			this._q_res_sceneid = value;
		}
		 ...
		 * @return 
		 */
		public function get q_res_lightid(): int{
			return _q_res_lightid;
		}
		
		/**
		 * set 场景骑兵光效资源
		 */
		public function set q_res_lightid(value: int): void{
			this._q_res_lightid = value;
		}
		
		/**
		 * get 骑兵技能ID（0：无技能，组合技能1的ID;组合技能2的ID;组合技能3的ID;组合技能4的ID;组合技能5的ID;）
		 * @return 
		 */
		...
		/**
		 * set 骑兵技能ID（0：无技能，组合技能1的ID;组合技能2的ID;组合技能3的ID;组合技能4的ID;组合技能5的ID;）
		 */
