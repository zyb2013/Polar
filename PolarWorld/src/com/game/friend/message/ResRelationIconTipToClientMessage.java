...
public class ResRelationIconTipToClientMessage extends Message{
	...
	//操作者信息
	private FriendModeInfo friendModeInfo;
	...
	public boolean write(IoBuffer buf){
		...
		//操作者信息
		writeBean(buf, this.friendModeInfo);
		return true;
	}
	...
	public boolean read(IoBuffer buf){
		...
		//操作者信息
		this.friendModeInfo = (FriendModeInfo)readBean(buf, FriendModeInfo.class);
		return true;
	}
	 ...
	 * set 操作者信息
	 */
	public void setFriendModeInfo(FriendModeInfo friendModeInfo){
		this.friendModeInfo = friendModeInfo;
	}
	...
	public String toString(){
		...
		//操作者信息
		if(this.friendModeInfo!=null) buf.append("friendModeInfo:" + friendModeInfo.toString() +",");
