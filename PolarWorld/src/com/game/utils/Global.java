...
public class Global {
	 ...
	 * 最大等级
	 */
	public static int MAX_LEVEL = 250;
	/**
	 * 最大战场声望
	 */
	 ...
	 * 暴击倍率(卓越一击) 
	 */
	public static double CRIT_ZHUOYUE = 1.2;
...
//	public static int BOSS_DIEING = 10000;
	 ...
	 * 普通怪掉落衰减等级
	 */
	public static int DROP_COMMON_GRADE_LIMIT=50;
	/**
	 * BOSS掉落衰减等级
	 */
	 ...
	 * 世界聊天最小等级
	 */
	public static short CHAT_WORLD_MIN_GRADE=28;
	/**
	 * 普通聊天最小时间间隔(秒)
	 */
	 ...
	 * 夜晚挂机保护buff开始时间(小时)
	 */
	public static int PROTECT_IN_NIGHT_START_HOUR = 22;
	/**
	 * 夜晚挂机保护buff开始时间(分钟)
	 */
	public static int PROTECT_IN_NIGHT_START_MINUTE = 30;
	/**
	 * 夜晚挂机保护buff结束时间
	 */
