...
public class Role {
	...
	private int strenth;//力量
	private int attPower;//体力
	private int agility;//敏捷
	private int intelligence;//智力
	private int restAttribute;//预留属性
	...
	public int getRestAttribute() {
		return restAttribute;
	}

	public void setRestAttribute(int restAttribute) {
		this.restAttribute = restAttribute;
	}
	...
	/**
	 * @param horseExp the horseExp to set
	 */
