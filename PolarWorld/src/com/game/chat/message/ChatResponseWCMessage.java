...
public class ChatResponseWCMessage extends Message{
	...
	public boolean write(IoBuffer buf){
		...
		//发送人的vip等级
		writeShort(buf, this.senderviplevel);		
		return true;
	}
	...
	public boolean read(IoBuffer buf){
	    ...
	    //发送人的vip等级
		this.senderviplevel = readShort(buf);
		return true;
	}
	 ...
	 * @return
	 */
	public short getSenderviplevel() {
	 ...
	 * set 发送人的vip等级
	 */
	public void setSenderviplevel(short senderviplevel) {
	...
	public String toString(){
		...
		//发送人的vip等级
		buf.append("senderviplevel:" + senderviplevel);
		if(buf.charAt(buf.length()-1)==',') buf.deleteCharAt(buf.length()-1);
		buf.append("]");
		return buf.toString();
	}
