...
import com.game.bank.handler.ReqQueryBankLogToWorldHandler;
import com.game.bank.handler.ReqSendBankLogToWorldHandler;
...
import com.game.guild.handler.ReqInnerGuildUpdateFightPowerToWorldHandler;
...
import com.game.newactivity.handler.ReqGetRankInfo2WorldHandler;
import com.game.newactivity.handler.ResGetActivityList2WorldHandler;
import com.game.newactivity.handler.ResUpdateActivity2WorldHandler;
...
import com.game.player.handler.ReqSyncPlayerJobToWorldHandler;
...
import com.game.player.handler.ReqSyncPlayerPataHandler;
...
import com.game.player.handler.ReqSyncPlayerRechargeHandler;
...
import com.game.question.handler.ReqGetQuestionChooseToWorldHandler;
import com.game.question.handler.ReqGetQuestionJoinToWorldHandler;
...
import com.game.toplist.handler.ReqGetGuildTopListToWorldHandler;
...
public class MessagePool {
	...
	public MessagePool(){
		...
		register(158301, ReqGetQuestionJoinToWorldMessage.class, ReqGetQuestionJoinToWorldHandler.class);
		register(158302, ReqGetQuestionChooseToWorldMessage.class, ReqGetQuestionChooseToWorldHandler.class);
		register(121327, ReqInnerGuildUpdateFightPowerToWorldMessage.class, ReqInnerGuildUpdateFightPowerToWorldHandler.class);
		
		//game查询 world 排行前5的公会
		register(542301, ReqGetTopGuildListToWorldMessage.class, ReqGetGuildTopListToWorldHandler.class);
		//同步玩家充值以及爬塔信息
		register(542302, ReqSyncPlayerRechargeMessage.class, ReqSyncPlayerRechargeHandler.class);
		register(542303, ReqSyncPlayerPataMessage.class, ReqSyncPlayerPataHandler.class);
		
		
		register(510308, ReqSendBankLogToWorldMessage.class, ReqSendBankLogToWorldHandler.class);
		register(510300, ReqQueryBankLogToWorldMessage.class, ReqQueryBankLogToWorldHandler.class);
		
		register(520300, ReqSyncPlayerJobToWorldMessage.class, ReqSyncPlayerJobToWorldHandler.class);
		//活动排名
		register(511308, ReqGetRankInfo2WorldMessage.class, ReqGetRankInfo2WorldHandler.class);
		//返回活动列表
		register(511311, ResGetActivityList2WorldMessage.class, ResGetActivityList2WorldHandler.class);
		//返回修改的活动信息
		register(511313, ResUpdateActivity2WorldMessage.class, ResUpdateActivity2WorldHandler.class);
	}
