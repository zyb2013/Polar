...
public class CountryStructureInfo extends Bean {
	...
	public String getHoldReward() {
		return holdReward;
	}

	public void setHoldReward(String holdReward) {
	...
	public boolean write(IoBuffer buf){
		...
		writeInt(buf, this.holdDay);
		writeString(buf, this.holdReward);
		return true;
	}
	...
	public boolean read(IoBuffer buf){
		...
		this.holdDay=readInt(buf);
		this.holdReward=readString(buf);
		return true;
	}
