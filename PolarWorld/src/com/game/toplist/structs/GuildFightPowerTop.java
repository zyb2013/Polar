 ...
 * @author  
 */
public class GuildFightPowerTop extends TopData{
	
	private int fightpower;
	private int level;

	public GuildFightPowerTop(long topid, int fightpower, int level) {
		super(topid);
	...
	public int compare(TopData otherTopData) {
		if (otherTopData instanceof GuildFightPowerTop) {
			GuildFightPowerTop othTop = (GuildFightPowerTop)otherTopData;
			if (othTop != null) {
