...
//		}
//		System.out.println(String.format("%s==%d==%d==%s", Card, crctype, randnum, argName));
...
//			erroridandret = Error_Fail;
//		}
//		System.out.println(String.format("%s==%d==%d==%d==%d==%s", Card, agid, crctype, nowtime, randnum, argName));
//		return erroridandret;
//	}
//
//	/**
